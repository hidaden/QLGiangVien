document.addEventListener("DOMContentLoaded", function () {
    ...
    const editMatKhauInput = editModal.querySelector('input[name="matkhau-chinhsua"]');
    const editMatKhauInputFirst = editModal.querySelector('input[name="matkhau-chinhsua-dau"]');
    ...
    editButtons.forEach(buttonn => {
        buttonn.addEventListener("click", function () {
            ...
            const titleElement = buttonn.closest('.document-card').querySelector('.title_taikhoan');
            const titleText = titleElement.innerText;

            editNameInput.value = titleText;
            editNameInputFirst.value = titleText;

            const titleElementt = buttonn.closest('.document-card').querySelector('.title_matkhau');
            const titleTextt = titleElementt.innerText;

            editMatKhauInput.value = titleTextt;
            editMatKhauInputFirst.value = titleTextt;
        });
    });
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    searchInput.addEventListener("input", function () {
        ...
        documentCards.forEach(function (card) {
            const titleElement = card.querySelector('.title_taikhoan');
